...
8. Confirm what you just did; make the following additional edits:
   * What is the location of the github: https://github.rpi.edu
   * What is your github ID: vakhrr
   * What is the name of your new branch: dar-vakhrr
   * What is the name of your new (copied) notebook: vakhrr-assignment1-f21.Rmd
