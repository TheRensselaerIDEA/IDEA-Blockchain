---
title: "DAR Defi Team Assignment 4 (Fall 2021)"
...
```{r}
borrowRateModeSummary <- df.borrow %>% filter(reserve %in% reservecoins$reserve) %>%
  group_by(reserve) %>%
  count(borrowRateMode) %>%
  mutate(percent = n/sum(n)*100)

kable(borrowRateModeSummary) 

userSummary <- df.borrow %>% filter(reserve %in% reservecoins$reserve) %>%
  group_by(user)
head(userSummary)
```
...
ggplot(df.borrow.DAI,aes(borrowRate, color = borrowRateMode)) +
  ggtitle("DAI borrow rate")+ 
  geom_density()

ggplot(df.borrow.DAI,aes(log10(amountUSD), color = borrowRateMode)) +
  ggtitle("DAI log10 borrow amount in USD")+ 
  geom_density()
```

```{r}
df.borrow.USDT <- df.borrow %>% filter(reserve == "USDT")
#summary(df.borrow.USDT)
ggplot(df.borrow.USDT,aes(borrowRate, color = borrowRateMode)) +
  ggtitle("USDT borrow rate")+ 
  geom_density()

ggplot(df.borrow.USDT,aes(log10(amountUSD), color = borrowRateMode)) +
  ggtitle("USDT log10 borrow amount in USD")+ 
  geom_density()
```
...
ggplot(df.borrow.USDC,aes(borrowRate, color = borrowRateMode)) +
  ggtitle("USDC borrow rate")+ 
  geom_density()

ggplot(df.borrow.USDC,aes(log10(amountUSD), color = borrowRateMode)) +
  ggtitle("USDC log10 borrow amount in USD")+ 
  geom_density()
```

```{r}
df.borrow.WBTC <- df.borrow %>% filter(reserve == "WBTC")
#summary(df.borrow.WBTC)
ggplot(df.borrow.WBTC,aes(borrowRate, color = borrowRateMode)) +
  ggtitle("WBTC borrow rate")+ 
  geom_density()

ggplot(df.borrow.WBTC,aes(log10(amountUSD), color = borrowRateMode)) +
  ggtitle("WBTC log10 borrow amount in USD")+ 
  geom_density()
```

```{r}
df.borrow.TUSD <- df.borrow %>% filter(reserve == "TUSD")
#summary(df.borrow.TUSD)
ggplot(df.borrow.TUSD,aes(borrowRate, color = borrowRateMode)) +
  ggtitle("TUSD borrow rate")+ 
  geom_density()

ggplot(df.borrow.TUSD,aes(log10(amountUSD), color = borrowRateMode)) +
  ggtitle("TUSD log10 borrow amount in USD")+ 
  geom_density()
```
...
ggplot(df.borrow.LINK,aes(borrowRate, color = borrowRateMode)) +
  ggtitle("LINK borrow rate")+ 
  geom_density()

ggplot(df.borrow.LINK,aes(log10(amountUSD), color = borrowRateMode)) +
  ggtitle("LINK log10 borrow amount in USD")+ 
  geom_density()
```
...
ggplot(df.borrow.new2,aes(borrowRatePercentage, color = reserve, linetype = borrowRateMode)) +
  ggtitle("Borrow rate for top coins")+ 
  geom_density()

ggplot(df.borrow.new2,aes(log10(amountUSD), color = reserve, linetype = borrowRateMode)) +
  ggtitle("Log10 borrow amount in USD for top coins")+ 
  geom_density()
