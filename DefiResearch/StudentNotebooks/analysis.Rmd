...
Time from deposit until first borrow - x
Survival of Borrows to Liquidations - x
How many transactions/time it takes to empty deposit fully
Net amount transacted each day
Predict Liquidations based on survival rates, time to liquidate
Users who liquidated vs had not