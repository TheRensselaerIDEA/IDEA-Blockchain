...
The feature I chose to forecast was unique users because I'd like to quantify just how big AAVE will become to see if there are any certain times during the year that spike in activity. My plan is to forecast this feature using both a Time Series Model and a Machine Learning Model and quantify how well each do with the data.
...
```{r}
# create new dataframe with unique user each day
