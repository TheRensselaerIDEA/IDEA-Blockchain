...
8. Confirm what you just did; make the following additional edits:
   * What is the location of the github: https://github.rpi.edu/DataINCITE/IDEA-Blockchain/tree/dar-cammic
   * What is your github ID: cammic
   * What is the name of your new branch: dar-cammic
   * What is the name of your new (copied) notebook: cammic-blockchain-notebook-f21.Rmd
