...
8. Confirm what you just did; make the following additional edits:
   * What is the location of the github: _https://github.rpi.edu/DataINCITE/IDEA-Blockchain.git_
   * What is your github ID: _ravins_
   * What is the name of your new branch: _dar-ravins_
   * What is the name of your new (copied) notebook: _ravins-assignment1-f21_
