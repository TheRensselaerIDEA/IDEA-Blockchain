...
wethLiquids <- liquidations %>%
  ...
  dplyr::select(user_alias,date,timestamp,type,liquidator,collateralAmount,collateralReserve,reservePriceUSDCollateral,principalAmount,principalReserve,reservePriceUSDPrincipal) %>%
