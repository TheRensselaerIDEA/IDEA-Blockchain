...
8. Confirm what you just did; make the following additional edits: I did do the above
   * What is the location of the github: https://github.rpi.edu/DataINCITE/IDEA-Blockchain
   * What is your github ID: _coolej_
   * What is the name of your new branch: _dar-coolej_
   * What is the name of your new (copied) notebook: _coolej-assignment1-f21.Rmd_
